...
tests/fm-send-paste-submit.test.sh        # long-steer / paste-collapse handling (incident fm-send-longmsg-loss): oversized-inline refusal, collapsed-paste discard with too-large verdict, submit confirmed by composer-clear OR pane-busy, and claude 2.1.224 NBSP-composer/ellipsis-spinner detection
